...
namespace Agiil.Web.Rendering.MarkdownExtensions
{
  public class AutoTicketLinkParser : InlineParser
  {
    ...
    public AutoTicketLinkParser(TicketReferenceParser referenceParser, Lazy<IGetsTicketUri> ticketUriProvider)
    {
      if(ticketUriProvider == null)
        throw new ArgumentNullException(nameof(ticketUriProvider));
      if(referenceParser == null)
        throw new ArgumentNullException(nameof(referenceParser));
      
      this.referenceParser = referenceParser;
      this.ticketUriProvider = ticketUriProvider;
