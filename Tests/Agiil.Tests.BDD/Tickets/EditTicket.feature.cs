...
#line 19
  testRunner.Given("Youssef has navigated to the ticket with the title \'Sample ticket 1\' and opened i" +
                    "t for editing", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line 20
   testRunner.When("he changes the ticket description to \'This is an edited description\' and clicks s" +
                    "ubmit", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 21
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Removing a ticket from all sprints should not cause it to be deleted")]
        public virtual void RemovingATicketFromAllSprintsShouldNotCauseItToBeDeleted()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Removing a ticket from all sprints should not cause it to be deleted", ((string[])(null)));
#line 36
this.ScenarioSetup(scenarioInfo);
#line 4
this.FeatureBackground();
#line 37
  testRunner.Given("Youssef has navigated to the ticket with the title \'Sample ticket 1\' and opened i" +
                    "t for editing", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line 38
   testRunner.When("he changes the ticket sprint to \'None\' and clicks submit", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 39
