...
namespace Agiil.Data.MappingProviders
{
    public class LowercaseWithUnderscoreDbNameFormatter : IDbNameFormatter
    {
        ...
        public string GetManyToManyTableName(Type primaryEntityType, string qualifier, Type secondaryEntityType)
        {
            return GetDatabaseName(String.Concat(primaryEntityType?.Name, ManyToManyJoiner, qualifier, secondaryEntityType?.Name));
        }
